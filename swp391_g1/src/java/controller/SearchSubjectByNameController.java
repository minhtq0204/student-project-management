...
public class SearchSubjectByNameController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (code.equalsIgnoreCase("1")) {
            lstSubject = dao.searchSubjectByName(name);
        }else if (code.equalsIgnoreCase("3")) {
            lstSubject = dao.searchSubjectByAuthor(name); 
        } else {
            lstSubject = dao.searchSubjectByCode(name);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SearchSubjectByNameController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
