 ...
 * @author mac
 */
@WebServlet(name = "FunctionDetailsController", urlPatterns = {"/detailsFunction"})
public class FunctionDetailsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FunctionEditController.class.getName()).log(Level.SEVERE, null, e);
        }
        ...
        request.getRequestDispatcher("function-detail.jsp").forward(request, response);
    }
