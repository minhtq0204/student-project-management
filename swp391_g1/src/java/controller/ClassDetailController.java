 ...
 * @author Thanh
 */
@WebServlet(name = "ClassDetailController", urlPatterns = {"/ClassDetailController"})
public class ClassDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Class class1 = classDAO.getOneClass(classID);
            System.out.println(class1);
            request.setAttribute("class", class1);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            if (classDAO.updateClass(classID, classCode, classYear, classTerm, block5, status, trainerID, subjectID)) {
