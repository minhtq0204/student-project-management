                ...
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">Edit Function</h3>
                                <ul class="breadcrumb">
                    ...
                    <form id="fuctionedit" name="myForm"  action="editFunction" method="post">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <input name="functionID" value="${function.functionID}" hidden="">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="functionName" value="${function.functionName}" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="accessRoles"
                                                           value="${function.accessRoles}" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="description">${function.description}</textarea>
                                                </div>
                                            </div>
