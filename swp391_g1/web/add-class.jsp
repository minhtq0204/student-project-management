                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="criteriadetails" name="criteriadetails" action="AddClassController" method="post" >
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="classCode" value="${requestScope.classCode}" required="">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="classYear">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="classTerm" pattern="[0-9]+" value="${requestScope.criorder}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <input type="radio" name="block5" value="1">
                                                        &nbsp;&nbsp;True
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="block5" value="0">
                                                        &nbsp;&nbsp;False
                                                    </div>
                                                </div>
