                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="addsubjectsetting" name="addsubjectsetting" action="AddSubjectSetting" method="post" >
                                        <div class="row">
                                            <div class="col-12">
                                                <h5 class="form-title"><span>Add Subject Setting</span></h5>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Type: </label>
                                                    <select name="typename" class="form-control" value="${requestScope.typename}" >
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="settingtitle" value="${requestScope.settingtitle}"required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="settingvalue"  value="${requestScope.settingvalue}" required="">
                                                </div>
                                            </div>
