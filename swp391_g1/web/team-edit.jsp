            ...
            <div class="content container-fluid">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                            <form id="editteam" name="myForm" method="post" action="editTeam">
                              <div class="row">
                                 <div class="col-12">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="gitURL" value="${team.gitURL}">
                                    </div>
                                 </div>
                                  <div class="col-12 col-sm-6">
                                    <div class="form-group">
