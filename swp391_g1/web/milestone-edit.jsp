                ...
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">Edit MileStone</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="">MileStones</a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form  action="MileStoneEditController" method="post">
                                        <div class="row">

                                            <div class="col-12">
                                                <h5 class="form-title"><span>MileStone Details</span></h5>
                                            </div>
                                            <input name="id" value="${ms.milestoneId}" hidden="">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="${ms.milestoneName}" class="form-control" name="MileStoneName" required="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" value="${ms.fromDate}" class="form-control" name="fromDate" required="">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>To date</label>
                                                    <input type="text" value="${ms.toDate}" class="form-control" name="toDate" required="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Description</label>
                                                    <textarea class="form-control" name="description">${ms.description} </textarea>
                                                </div>
                                            </div>      
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <c:if test="${ms.status eq 0}">
                                                        <input type="radio"  name="status" checked="" value="0"> Closed
                                                        <input type="radio"  name="status" value="1"> Open
                                                        <input type="radio" name="status" value="2"> Canceled
                                                    </c:if>
                                                    <c:if test="${ms.status eq 2}">
                                                        <input type="radio"  name="status" value="0"> Closed
                                                        <input type="radio"  name="status" value="1"> Open
                                                        <input type="radio" checked="" name="status" value="2"> Canceled
                                                    </c:if>
                                                </div>
                                            </div>        
                                            <div class="col-12">
