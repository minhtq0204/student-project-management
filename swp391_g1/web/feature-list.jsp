                    ...
                    <div class="position-fixed bottom-0 end-0 p-3" style="right: 10px; bottom: 10px; z-index: 11">
                        <div class="toast" data-autohide="true">
                            ...
                            <div class="toast-body">
                                Create new feature successfully.
                            </div>
                        </div>
                    </div>
                </c:when>
                ...
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <form action="SeachFeatureController" method="get">
                                <div class="col-auto text-right float-right">
                                    ...
                                    &emsp;
                                    Topic &ensp; <select name="teamID" style="background-color: #f5f4f1;
                                                        border-color: #FFBC53;">
                                        <option selected value="0">All Topic</option>
                                        <c:forEach items="${listTeam}" var="team">
                                            <option ${teamID == team.teamID ?"selected":""} value="${team.teamID}"> ${team.topicName} </option>
                                        </c:forEach>
                                    </select>
                                    &emsp;
                                    ...
                                    <a href="AddFeatureController" class="btn btn-outline-primary mr-2"><i class="fas fa-plus"></i> Add Feature</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class=" table table-stripped">
                                            ...
                                            <tbody>
                                                <c:forEach items="${listFeature}" var="f">
                                                    <tr>
                                                        <td>
                                                            ${f.featureName}
                                                        </td>
                                                        ...
                                                        <td class="text-left"> 
                                                            <div class="actions">
                                                                <a href="FeatureController?id=${f.featureID}" class="btn btn-sm bg-success-light mr-2">
                                                                    <span><i class="fas fa-pen"></i> Edit</span>
                                                                </a>

                                                                <a class="btn btn-sm bg-success-light mr-2">
                                                                    <form method="post" action="ChangeStatusFeature">
                                                                        <input type="text" name="id" value="${f.featureID}" hidden="">
                                                                        <c:if test="${f.status == 1}">
                                        ...
                                        <div class="col-auto text-right float-right">
                                            <div class="pagination">
                                                ...
                                                <c:forEach begin="1" end="${endPage}" var="i">
                                                    <a href="FeatureList?index=${i}">${i}</a> 
                                                </c:forEach>
                                                <a href="#">&raquo;</a>
                                            </div>
                                        </div>
