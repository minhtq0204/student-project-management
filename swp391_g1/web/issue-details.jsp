                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="issuedetails" name="issuedetails" action="IssueDetailsController" method="post" >
                                        <div class="row">
                                            <div class="col-12">
                                                <h5 class="form-title"><span>Add Issue</span></h5>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Issue Title (*) : </label>
                                                    <input type="text" class="form-control" name="issuetitle" value="${requestScope.issuetitle}" required="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="assignname" class="form-control" value="${requestScope.assignname}" >
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="giturl" value="${requestScope.giturl}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="duedate"  value="${requestScope.duedate}" required="">
                                                    </div>
                                                </div>
