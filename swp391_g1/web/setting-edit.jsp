                                ...
                                <div class="card-body">
                                    <form method="post" action="updateSetting">
                                        <div class="row">
                                            ...
                                            <input name="id" value="${setting.settingID}" hidden="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="typeId" class="form-control">
                                                        <c:forEach items="${listType}" var="type">
                                                            <c:choose>
                                                                <c:when  test="${type.typeId == setting.typeId}">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="settingValue" 
                                                           value="${setting.settingValue}" required="">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="settingNote"
                                                           value="${setting.settingNote}" >
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Status : </label>
                                                    <br>
                                                    <input type="radio" name="status" value="1"<c:if test="${setting.status eq 1}">checked=""</c:if>>
                                                        &nbsp;&nbsp;Active
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="status" value="0"<c:if test="${setting.status eq 0}">checked=""</c:if>>
                                                    &nbsp;&nbsp;Inactive
                                                </div>
                                            </div> 
                                            <div class="col-12">
