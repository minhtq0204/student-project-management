                ...
                <div class="position-fixed bottom-0 end-0 p-3" style="right: 10px; bottom: 10px; z-index: 11">
                    <div class="toast" data-autohide="false">
                        ...
                        <div class="toast-body">
                            Create new milestone successfully.
                        </div>
                    </div>
                </div>
            </c:when>
                ...
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <form action="MilestoneSearch" method="get">
                                <div class="col-auto text-right float-right">
                                    ...
                                    <a href="addMilestone" class="btn btn-outline-primary mr-2"><i class="fas fa-plus"></i> Add
                                        Milestone</a>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <c:forEach items="${MileStone}" var="x">
                                                    <tr>
                                                        <td>${x.milestoneName}</td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="actions">
                                                                <a href="MileStoneEditController?id=${x.milestoneId}" class="btn btn-sm bg-success-light mr-2">
                                            ...
                                            <div class="pagination">
                                                ...
                                                <c:forEach begin="1" end="${endPage}" var="i">
                                                    <c:if test="${countSearch > 0}">
                                                        <a href="MilestoneSearch?index=${i}&classID=${classID}&status=${status}">${i}</a>
                                                    </c:if>
                                                    <c:if test="${countSearch == 0}">
                                                        <a href="MilestoneListController?index=${i}">${i}</a>
                                                    </c:if>
                                                </c:forEach>
